...
var keyLength = 32;
var digest = 'sha256';
var xeranthemum = new pollenium_forgetmenot_1.Forgetmenot(__dirname + "/../addresses");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, xeranthemum.set(name, address)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getAddress(name) {
    return new pollenium_buttercup_1.Address(xeranthemum.get(name));
}
