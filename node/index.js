...
var prompt_password_1 = __importDefault(require("prompt-password"));
...
function promptPrivateKey() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new prompt_password_1["default"]({
                        name: 'know',
                        type: 'password',
                ...
                case 1:
                    knowUtf8 = _a.sent();
                    return [4 /*yield*/, new prompt_password_1["default"]({
                            name: 'have',
                            type: 'password',
